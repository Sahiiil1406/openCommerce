...
import { useGetProductByIDMutation } from "../store/slice/product";
    ...
    const fetchProduct = async () => {
      try {
        const data = await getProductByID({
          id: "67124d7e6131157ed6e1f495",
        }).unwrap();
        const productData = data.gateway.result[0];

        // Map API response data to frontend structure
        const mappedProduct = {
          ...
          suggestedProducts: [], // No suggested products in API response; you can add logic if available
        };

        // Set the mapped product data in state
